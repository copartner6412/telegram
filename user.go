...
type User struct {
	// (Required) Unique identifier for this user or bot. This number may have more than 32 significant bits
	...
	// (Optional) True, if privacy mode is disabled for the bot. Returned only in getMe. https://core.telegram.org/bots/features#privacy-mode
